...
public class StreamGifImageView extends ImageView implements Runnable {
    ...
    public StreamGifImageView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }

    public StreamGifImageView(final Context context) {
        super(context);
    }

    public void setBytes(final FileInputStream bytes) {
